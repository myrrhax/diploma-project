...
public enum ErrorMessageKey {
    ...
    COLUMN_MAX_VIOLATION("error.column.max-violation"),
    COLUMN_MIN_PRECISION_VIOLATION("error.column.min-precision-violation"),
    COLUMN_MAX_PRECISION_VIOLATION("error.column.max-precision-violation"),
    COLUMN_MIN_LENGTH_VIOLATION("error.column.min_length-violation"),
    COLUMN_MAX_LENGTH_VIOLATION("error.column.max_length-violation"),
    COLUMN_MIN_VIOLATION("error.column.min-violation"),
    COLUMN_DEFAULT_MIN_VIOLATION("error.column.default-min-violation"),
    COLUMN_DEFAULT_MAX_VIOLATION("error.column.default-max-violation"),
